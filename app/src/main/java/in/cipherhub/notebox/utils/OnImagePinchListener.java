...
public class OnImagePinchListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
  ...
  public OnImagePinchListener(Context context, ImageView srcImageView) {
...
//
    ...
    srcImageView.setScaleX(xScale);
    srcImageView.setScaleY(yScale);
//
//    srcImageView.setWidth((int) (srcImageView.getWidth() * xScale));
//    srcImageView.setHeight((int) (srcImageView.getHeight() * yScale));
